...
- 중간 중간 프로젝트 하는 기간이 있어서, 취업에 필요한 역량(코테,면접,추가 인강)을 기르기 좋다.
...
--- 
+ 조금 나이가 있으신걸로 말씀을 주셔서, 저는 구름톤 트레이닝 쪽으로 더 추천 드리고 싶네요.
- 해당 트랙도 프런트쪽으로도 충분히 취업 가능한 기술 래벨입니다. 
- 백 + 프런트 + DevOps까지 전체 큰 그림을 알아서, 커뮤니케이션과 업무 도메인 이해를 빠르게 이해해서 다른 젋은 신입과 차별성을 가져가면 좋겠네요.!